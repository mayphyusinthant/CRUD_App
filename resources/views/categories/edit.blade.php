            ...
            <div class = "col-6 px-5">
                <h6> Item Information</h6>
                    <div class = "form-group">
                        ...
                        <input type = "text" name = "name" class="form-control" placeholder = '{{ $category->name}}' required></input>
                    </div><br/>
                    ...
                    <input type = "button" value = "Cancel" class = "btn btn-light" onclick="window.location.href='{{ route('categories.index') }}';">
