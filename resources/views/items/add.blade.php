...
<div class="row mx-5">
    <div class = "col-2">
        <h3>Admin Panel </h3>
        <br/>
        <div id = "label" class = "rounded p-1">
        ...
        <div class = "row">
            <div class = "col-6 px-5">
                <h6> Item Information</h6>
                    ...
                    <div class = "form-group">
                        <label>Price</label>
                        <input type = "text" name = "price" class="form-control" placeholder = "Enter Price" required></input>
                    </div><br/>

                    <div class = "form-group">
                        <label>Description</label>
                        <textarea type = "text" name = "description" class="form-control" 
                            rows = "4" cols = "6" placeholder = "Enter Description" required> </textarea>
                        </input>
                    </div><br/>
            ...
            <div class = "col-6 px-5">  
                ...
                <div class = "form-group">
                        ...
                        <input type = "text" name = "owner" class="form-control" placeholder = "Input Owner Name" required></input>
                </div><br/>

                <div class = "form-group">
                    <label>Contact Number</label>
                    <input type = "text" name = "number" class="form-control" placeholder = "Add Number" required></input>
                </div><br/>

                <div class = "form-group">
                    <label>Address</label>
                    <textarea type = "text" name = "address" class="form-control" 
                            rows = "4" cols = "6" placeholder = "Enter address" required> </textarea>
                        </input>
                </div><br/>
